...
export default function SpectatorView() {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-black text-white font-sans">
      ...
      <main className={`flex-1 flex flex-col xl:flex-row p-4 md:p-6 gap-6 z-10 relative ${status === 'PAUSED' ? 'h-[calc(100vh-100px)] overflow-hidden' : 'min-h-[calc(100vh-100px)] xl:h-[calc(100vh-100px)] overflow-y-auto xl:overflow-hidden'}`}>
      {/* STATS MODAL (PAUSED) */}
      <AnimatePresence>
        {status === 'PAUSED' && (
          <motion.div
