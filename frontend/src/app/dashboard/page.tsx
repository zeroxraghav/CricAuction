                ...
                <div key={auction.id} className="glass-panel p-6 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 border hover:border-white/20 transition-all">
                  <div>
                    ...
                    <div className="mt-4 flex items-center gap-2 text-sm">
                      <span className="bg-white/10 px-3 py-1 rounded-full text-gray-300 flex items-center gap-2">
                        <Users className="w-4 h-4"/> Share Link: 
                      </span>
                      <button 
                        onClick={() => copyToClipboard(auction.id)}
                        className="flex items-center gap-2 text-brand hover:text-brand/80 bg-brand/10 hover:bg-brand/20 px-3 py-1 rounded-full transition"
                      >
                        {copiedId === auction.id ? (
